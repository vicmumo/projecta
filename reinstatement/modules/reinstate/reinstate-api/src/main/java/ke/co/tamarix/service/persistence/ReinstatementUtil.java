...
/**
 * The persistence utility for the reinstatement service. This utility wraps <code>ke.co.tamarix.service.persistence.impl.ReinstatementPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ReinstatementPersistence
 * @generated
 */
public class ReinstatementUtil {
	 ...
	 */
	public static void clearCache(Reinstatement reinstatement) {
		getPersistence().clearCache(reinstatement);
	}
	 ...
	 */
	public static Map<Serializable, Reinstatement> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Reinstatement> findWithDynamicQuery(
	 ...
	 */
	public static Reinstatement update(Reinstatement reinstatement) {
		return getPersistence().update(reinstatement);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static Reinstatement update(
		Reinstatement reinstatement, ServiceContext serviceContext) {

		return getPersistence().update(reinstatement, serviceContext);
	}
	 ...
	 */
	public static List<Reinstatement> findByUuid(String uuid) {
	 ...
	 */
	public static List<Reinstatement> findByUuid(
	 ...
	 */
	public static Reinstatement findByUuid_First(
			String uuid, OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 */
	public static Reinstatement fetchByUuid_First(
		String uuid, OrderByComparator<Reinstatement> orderByComparator) {
	 ...
	 * @throws NoSuchReinstatementException if a matching reinstatement could not be found
	 */
	public static Reinstatement findByUuid_Last(
			String uuid, OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 */
	public static Reinstatement fetchByUuid_Last(
		String uuid, OrderByComparator<Reinstatement> orderByComparator) {
	 ...
	 */
	public static Reinstatement[] findByUuid_PrevAndNext(
			long reinstatementId, String uuid,
			OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {

		return getPersistence().findByUuid_PrevAndNext(
			reinstatementId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchReinstatementException if a matching reinstatement could not be found
	 */
	public static Reinstatement findByUUID_G(String uuid, long groupId)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 */
	public static Reinstatement fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching reinstatement, or <code>null</code> if a matching reinstatement could not be found
	 */
	public static Reinstatement fetchByUUID_G(
	 ...
	 */
	public static Reinstatement removeByUUID_G(String uuid, long groupId)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 * @return the matching reinstatements
	 */
	public static List<Reinstatement> findByUuid_C(
	 ...
	 * @throws NoSuchReinstatementException if a matching reinstatement could not be found
	 */
	public static Reinstatement findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 * @return the first matching reinstatement, or <code>null</code> if a matching reinstatement could not be found
	 */
	public static Reinstatement fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Reinstatement> orderByComparator) {
	 ...
	 * @throws NoSuchReinstatementException if a matching reinstatement could not be found
	 */
	public static Reinstatement findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {
	 ...
	 * @return the last matching reinstatement, or <code>null</code> if a matching reinstatement could not be found
	 */
	public static Reinstatement fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Reinstatement> orderByComparator) {
	 ...
	 * @throws NoSuchReinstatementException if a reinstatement with the primary key could not be found
	 */
	public static Reinstatement[] findByUuid_C_PrevAndNext(
			long reinstatementId, String uuid, long companyId,
			OrderByComparator<Reinstatement> orderByComparator)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {

		return getPersistence().findByUuid_C_PrevAndNext(
			reinstatementId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(Reinstatement reinstatement) {
		getPersistence().cacheResult(reinstatement);
	}
	 ...
	 */
	public static void cacheResult(List<Reinstatement> reinstatements) {
		getPersistence().cacheResult(reinstatements);
	}
	 ...
	 */
	public static Reinstatement create(long reinstatementId) {
		return getPersistence().create(reinstatementId);
	}
	 ...
	 * @throws NoSuchReinstatementException if a reinstatement with the primary key could not be found
	 */
	public static Reinstatement remove(long reinstatementId)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {

		return getPersistence().remove(reinstatementId);
	}

	public static Reinstatement updateImpl(Reinstatement reinstatement) {
		return getPersistence().updateImpl(reinstatement);
	}
	 ...
	 * @throws NoSuchReinstatementException if a reinstatement with the primary key could not be found
	 */
	public static Reinstatement findByPrimaryKey(long reinstatementId)
		throws ke.co.tamarix.exception.NoSuchReinstatementException {

		return getPersistence().findByPrimaryKey(reinstatementId);
	}
	 ...
	 */
	public static Reinstatement fetchByPrimaryKey(long reinstatementId) {
		return getPersistence().fetchByPrimaryKey(reinstatementId);
	}
	 ...
	 */
	public static List<Reinstatement> findAll() {
	 ...
	 */
	public static List<Reinstatement> findAll(int start, int end) {
	...
	public static ReinstatementPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ReinstatementPersistence, ReinstatementPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ReinstatementPersistence.class);

		ServiceTracker<ReinstatementPersistence, ReinstatementPersistence>
			serviceTracker =
				new ServiceTracker
					<ReinstatementPersistence, ReinstatementPersistence>(
						bundle.getBundleContext(),
						ReinstatementPersistence.class, null);
